...
module.exports = "<article *ngIf=\"profileData\">\n  <header>\n    <div class=\"profile-img\">\n      <div class=\"img-center\"><img [src]=\"profileData.avatar\"></div>\n    </div>\n    <div class=\"profile-info\">\n      <div class=\"title\">\n        <h1 title=\"{{profileData.username}}\">{{profileData.username}}</h1>\n        <span class=\"verified-badge-icon\" title=\"Verified\" *ngIf=\"profileData.verified\">Verified</span>\n      </div>\n      <ul class=\"counts\">\n        <li><span class=\"count-item\">\n          <span class=\"bold-text\">{{profileData.count.posts | formatNumbers}}</span> posts</span>\n        </li>\n        <li><a class=\"count-item\" href=\"#/{{profileData.username}}\">\n          <span class=\"bold-text\" title=\"{{profileData.count.followers}}\">{{profileData.count.followers | formatNumbers}}</span> followers</a>\n        </li>\n        <li><a class=\"count-item\" href=\"#/{{profileData.username}}\">\n          <span class=\"bold-text\">{{profileData.count.following | formatNumbers}}</span> following</a>\n        </li>\n      </ul>\n      <div class=\"description\">\n        {{profileData.description}}\n      </div>\n    </div>\n  </header>\n  <div class=\"gallery\">\n    <div>\n      <div *ngFor=\"let item of profileData.gallery; let i = index\">\n        <div class=\"gallery-row\" *ngIf=\"i % 3 == 0\">\n          <div class=\"gallery-item\">\n            <a (click)=\"explorePost(profileData.gallery[i].id)\">\n              <div class=\"preview-container\">\n                <div class=\"img-holder\"><img [src]=\"profileData.gallery[i].picture.url\"></div>\n                <div class=\"shift\"></div>\n              </div>\n              <div class=\"img-overflow\">\n                <ul>\n                  <li><span>{{profileData.gallery[i].likes | formatNumbers}}</span><span class=\"heart-small-icon\">likes</span></li>\n                  <li><span>{{profileData.gallery[i].posts | formatNumbers}}</span><span class=\"speech-bubble-small-icon\">comments</span></li>\n                </ul>\n              </div>\n            </a>\n          </div>\n          <div class=\"gallery-item\" *ngIf=\"profileData.gallery.length > (i + 1)\">\n            <a (click)=\"explorePost(profileData.gallery[i+1].id)\">\n              <div class=\"preview-container\">\n                <div class=\"img-holder\"><img [src]=\"profileData.gallery[i+1].picture.url\"></div>\n                <div class=\"shift\"></div>\n              </div>\n              <div class=\"img-overflow\">\n                <ul>\n                  <li><span>{{profileData.gallery[i+1].likes | formatNumbers}}</span><span class=\"heart-small-icon\">likes</span></li>\n                  <li><span>{{profileData.gallery[i+1].posts | formatNumbers}}</span><span class=\"speech-bubble-small-icon\">comments</span></li>\n                </ul>\n              </div>\n            </a>\n          </div>\n          <div class=\"gallery-item\" *ngIf=\"profileData.gallery.length > (i + 2)\">\n            <a (click)=\"explorePost(profileData.gallery[i+2].id)\">\n              <div class=\"preview-container\">\n                <div class=\"img-holder\"><img [src]=\"profileData.gallery[i+2].picture.url\"></div>\n                <div class=\"shift\"></div>\n              </div>\n              <div class=\"img-overflow\">\n                <ul>\n                  <li><span>{{profileData.gallery[i+2].likes | formatNumbers}}</span><span class=\"heart-small-icon\">likes</span></li>\n                  <li><span>{{profileData.gallery[i+2].posts | formatNumbers}}</span><span class=\"speech-bubble-small-icon\">comments</span></li>\n                </ul>\n              </div>\n            </a>\n          </div>\n        </div>\n      </div>\n    </div>\n    <a href=\"#\" class=\"load-more-btn\" *ngIf=\"false\">Load more</a>\n  </div>\n</article>\n<app-post-view (isShownChange)=\"postId=''\" [postId]=\"postId\"></app-post-view>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_pipes_shared_pipes_module__ = __webpack_require__("../../../../../src/app/shared/pipes/shared-pipes.module.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__profile_component__ = __webpack_require__("../../../../../src/app/profile/profile.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
ProfileModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_4__shared_pipes_shared_pipes_module__["a" /* SharedPipesModule */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* RouterModule */].forChild([
                {
                    path: '',
                    component: __WEBPACK_IMPORTED_MODULE_6__profile_component__["a" /* ProfileComponent */],
                },
            ]),
        ],
        declarations: [
